...
/**
 * Servlet implementation class ChangeStateQueryServlet
 */
@WebServlet("/ChangeStateQueryServlet")
public class ChangeStateQueryServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ChangeStateQueryServlet() {
        super();
