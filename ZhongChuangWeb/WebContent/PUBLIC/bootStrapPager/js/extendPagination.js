...
(function ($) {
    $.fn.extendPagination = function (options) {
        ...
        /*alert(defaults.currPage);
        alert(defaults.totalCount);
        alert(defaults.limit);
        alert(defaults.showPage);*/
        ...
        if (totalPage > 0) {
            ...
            if (totalPage <= showPage) {
                for (var i = 1; i <= totalPage; i++) {
                    if (i == currPage) html.push(' <li class="active"><a href="#">' + i + '</a></li>');
                    else html.push(' <li><a href="#">' + i + '</a></li>');
                }
            } else {
                for (var j = 1; j <= showPage; j++) {
                    if (j == currPage) html.push(' <li class="active"><a href="#">' + j + '</a></li>');
