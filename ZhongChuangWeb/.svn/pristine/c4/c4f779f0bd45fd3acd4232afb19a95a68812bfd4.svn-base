...
/**
 * Servlet implementation class UpdateProjectIdQueryServlet
 */
@WebServlet("/UpdateProjectIdQueryServlet")
public class UpdateProjectIdQueryServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateProjectIdQueryServlet() {
        super();
