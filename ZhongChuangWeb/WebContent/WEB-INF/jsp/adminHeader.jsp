														    ...
														    <div class="modal-body">
															   <form class=form-horizontal method=post action="${pageContext.request.contextPath}/servlet/admin/UploadExcelServlet" id="ExcelUpForm" role="form"  enctype="multipart/form-data">
																	<div class=form-group id="inputProgramBill">
																					<div class=col-lg-8>	
																						<label class="control-label " for="ProgramBill">上传项目excel表格：</label>									
		...
		<div id="wrapper">
 				<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">	           
					    <div class="navbar-header">
						    <form class="navbar-form navbar-left" role="search" action="${pageContext.request.contextPath}/servlet/admin/AdminQueryUserNoServlet" id="inputQueryUserNoForm">
						    	<div class="input-group" id="inputQueryUserNoFrame">
						      		<input type="text" class="form-control" id="inputQueryUserNo"  name="id"  placeholder="按学号搜索" onblur="check_inputQueryUserNo()">	
						      		<span class="glyphicon glyphicon-ok form-control-feedback" id="inputQueryUserNoSuccess" style="visibility:hidden"></span>
						      		<span class="glyphicon glyphicon-remove form-control-feedback" id="inputQueryUserNoError" style="visibility:hidden"></span>
						        </div>
						        <div hidden>
						        	<input id="base" value="${pageContext.request.contextPath}">
						        </div>
						        <button type="button" class="btn btn-default" onclick="queryUserNoSubmit()"><i class="glyphicon glyphicon-search"></i>查询</button>
					    ...
					    <p class="navbar-text navbar-center">管理员界面</p> 
					    </div>	
	            ...
	            <div class="navbar-default sidebar" role="navigation">
	                <div class="sidebar-nav navbar-collapse">
	                    <ul class="nav" id="side-menu">
	                   		  <li>
	                        	   <a href="#"><i class="fa fa-plus-circle"></i>项目表格<span class="fa arrow"></span></a>
			                        <ul class="nav nav-second-level">
				                        <li>
				                            <a data-toggle="modal" data-target="#myModal" href="#" ><i class=""></i> 导入表格</a>
				                         </li>
				                         <li>
				                            <a href="${pageContext.request.contextPath}/servlet/admin/BuildExcelServlet"><i class=""></i> 下载表格</a>
				                        </li>
			                        </ul>
	                    </ul>
	                </div>
